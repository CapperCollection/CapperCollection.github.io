...
export const events: EventsTypes = [
  ...
  {
    eps: 106,
    type: "SterlingAlwaysWins",
    context: "Leverage Inc",
    timestamp: "41:50",
    character: "James Sterling",
    subject: "",
    text: [
      "And bringing Kentucky Thunder's trainer? That wrapped things up nicely for us. Made you look like an idiot but helped us out.",
      "And that paperwork that you had Foster sign helped me save the company a pile of money in the payout. And you know from personal experience just how much they hate to write a check.",
    ],
  },
  {
    eps: 107,
  ...
  },
  {
    eps: 112,
    type: "RecurringCharacter",
    context: "Armored Truck",
    timestamp: "29:40",
    character: "James Sterling",
    subject: "Parker",
    text: ["You know I don't think we've ever been properly introduced."],
  },
  {
    eps: 112,
    type: "RecurringMaguffin",
  ...
  },
  {
    ...
    context: "Museum",
    timestamp: "00:10",
    character: "Ian Blackpoole",
    subject: "Nate Ford",
    text: ["Where are they?", "Are you here to kill me Ian?"],
  },
  {
    eps: 113,
    type: "SterlingAlwaysWins",
    ...
    timestamp: "00:26",
    character: "James Sterling",
    subject: "The newest vice president of IYS",
    text: [],
  },
  {
    eps: 113,
  ...
  },
  {
    ...
    text: [
      ...
      "Theft... yeah I'm going to rob the two Davids gallery on opening day.",
    ],
  },
  {
    eps: 113,
    ...
    text: [
      ...
      "People lost thier homes, children, lives!",
      "No exceptions.",
    ],
  },
  {
    ...
    character: "Elliot Spencer",
    subject: "Alec Hardison",
    text: ["What are you doing? Damnit Hardison!", "This is my spot, you go!"],
  },
  {
    eps: 113,
    type: "MotiveInsight",
    context: "Merritt Mansion, LA",
    timestamp: "09:00",
    character: "Nate Ford",
    subject: "Leverage Inc",
    text: [
      "We agreed to scatter for six months. All of you, all of you made an amateur move beign there.",
      "Its too hard to leave a job undone. Its like and itch.",
      "I put a lot of work into us; into that office. It was liek a second home. I blew up my second home.",
      "Ass annoying as you people are I quite this crew when I quit this crew. Nobody makes me leave.",
      "I just really wanted to hurt Sterling",
    ],
  },
  {
    eps: 113,
    ...
    subject: "Leverage Inc",
    text: [
      "Grifter, hitter, hacker thief. You're all trying to solve your version of the crime, instead of just trying to solve the crime. There is a reason we worked together.",
    ],
  },
  {
    eps: 113,
  ...
  },
  {
    ...
    timestamp: "23:13",
    character: "Sophie Devereaux",
    subject: "Dr. Ramen of the Cairo Museum",
    text: [],
  },
  {
    eps: 113,
    ...
    text: [
      ...
      "D E D dead baby.",
      "D E A D",
      "I... I know how... I was throwing a little style, just a little bit. Little style. I know how to spell dead damn it. I can steal a bank. I can spell dead.",
    ],
  },
  {
    eps: 113,
  ...
  },
  {
    ...
    text: [
      "Elliot Spencer?",
      "Elliot Spencer, wanted in five coutnries, including Myanmar which is offering a half million dollar bounty on his head.",
      "Bringing Spencer to Justice and getting paid for it icing on the cake. Parker?",
      "Wanted in nine coutries includeing Brazil and Yemen.",
      "Yeah, tough choice. I'll have to flip a coin. How about Sophie Devereaux?",
      "England, France, Spain, Luxembourg. Europe basically.",
      "France, wonderful shopping. Horrifying prisons. Alec Hardison?",
      "He better not show his face in Iceland.",
  ...
  },
  {
    ...
    subject: "Alec Hardison",
    text: [
      "When the owners of these paintings realize that Ian knew there was going to be a theft but didn't call the police, well they're going to sue the hell out of him aren't they?",
      "But if the company in good faith returns their paintings...",
      "They might not fire you, if you give them Blackpoole.",
    ],
  },
  {
    eps: 113,
